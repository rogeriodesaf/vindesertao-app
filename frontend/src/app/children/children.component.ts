            ...
            <tbody>
              @for (record of records(); track record.id) {
                <tr (click)="edit(record)">
                  <td data-label="Criança">{{ record.childName }}</td>
                  <td data-label="Responsável">{{ record.guardianName || '-' }}</td>
                  <td data-label="Idade">{{ record.age ?? '-' }}</td>
                  <td data-label="Atividade">{{ record.activityName || '-' }}</td>
                  <td data-label="Bairro">{{ record.neighborhood || '-' }}</td>
                  <td data-label="Cadastrado por">{{ record.responsibleUserName || '-' }}</td>
